...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    ...
    >
      <span
        className={`absolute left-1 top-1 w-4 h-4 bg-white dark:bg-gray-900 rounded-full shadow-sm transform transition-transform duration-300 flex items-center justify-center ${
