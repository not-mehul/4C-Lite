...
import { UPLOAD_PROGRESS_INTERVAL, UPLOAD_PROGRESS_INCREMENT } from '../utils/constants';
            ...
            <>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  or <span className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium">browse to upload</span>
                </p>
              </div>
            </>
          )}
