...
> If you edit a camera's details to add or correct its Resolution (MP) and Channel Count, an "Export Modified" button will appear. You can use this to export the updated information as a YAML file. Please consider sharing this file with me so it can be added to the database, improving the tool for everyone\!
